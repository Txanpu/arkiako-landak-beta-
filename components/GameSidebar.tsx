...
export const GameSidebar: React.FC<GameSidebarProps> = ({ 
    ...
    return (
        <div className="w-80 h-full bg-[#0b1120] border-l border-white/5 flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.5)] z-20 relative">
            ...
            {/* Logs Area */}
            <div className="h-32 bg-black border-t border-slate-800 p-3 font-mono text-[10px] overflow-y-auto text-gray-400 custom-scrollbar relative">
