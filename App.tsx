...
import { PokemonModal } from './components/modals/PokemonModal'; // NEW
  ...
  return (
    <div className="flex w-screen h-screen bg-[#050505] text-slate-100 overflow-hidden font-sans">
      <div className="flex-1 relative overflow-hidden flex items-center justify-center bg-[#050505]">
        ...
        {/* Simple Weather Indicator (No full overlay) */}
        {state.world.weather === 'rain' && (
            <div className="absolute top-4 right-4 pointer-events-none z-20 text-blue-400 opacity-50 font-bold">🌧️ LLUVIOSO</div>
        )}
